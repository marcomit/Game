...
function() {
    ...
    function s(e) {
        this.el = e;
        for (var t = e.className.replace(/^\s+|\s+$/g, "").split(/\s+/), i = 0; i < t.length; i++)
            n.call(this, t[i])
    }
}(),
function() {
...
KeyboardInputManager.prototype.listen = function() {
    ...
    document.addEventListener("keydown", (function(e) {
        var t = e.altKey || e.ctrlKey || e.metaKey || e.shiftKey
          , n = o[e.which];
        i.targetIsInput(e) || (t || void 0 !== n && (e.preventDefault(),
        i.emit("move", n)),
        t || 82 !== e.which || i.restart.call(i, e))
    }
    )),
    ...
    n.addEventListener(this.eventTouchstart, (function(o) {
        !window.navigator.msPointerEnabled && o.touches.length > 1 || o.targetTouches.length > 1 || i.targetIsInput(o) || (window.navigator.msPointerEnabled ? (e = o.pageX,
    ...
    n.addEventListener(this.eventTouchend, (function(o) {
        if (!(!window.navigator.msPointerEnabled && o.touches.length > 0 || o.targetTouches.length > 0 || i.targetIsInput(o))) {
            var n, a;
            window.navigator.msPointerEnabled ? (n = o.pageX,
            a = o.pageY) : (n = o.changedTouches[0].clientX,
...
HTMLActuator.prototype.addTile = function(e) {
    ...
    )) : e.mergedFrom ? (r.push("tile-merged"),
    this.applyClasses(i, r),
...
Grid.prototype.empty = function() {
    for (var e = [], t = 0; t < this.size; t++)
        for (var i = e[t] = [], o = 0; o < this.size; o++)
            i.push(null);
    return e
}
,
...
Grid.prototype.serialize = function() {
    for (var e = [], t = 0; t < this.size; t++)
        for (var i = e[t] = [], o = 0; o < this.size; o++)
            i.push(this.cells[t][o] ? this.cells[t][o].serialize() : null);
    return {
        size: this.size,
        cells: e
    }
...
GameManager.prototype.move = function(e) {
    ...
    if (!this.isGameTerminated()) {
        var i, o, n = this.getVector(e), a = this.buildTraversals(n), r = !1;
        this.prepareTiles(),
